...
need to have leader listen to gossip for new nodes
when a new node is added and its node id isn't in the master set
we should start adding a learner

I think learners need to have their ID seeded in their persisted config
